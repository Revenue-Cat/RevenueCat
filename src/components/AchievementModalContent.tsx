          ...
          {isRegularAchievement(achievement.id) ? (
            ...
            <>
              ...
              {(progress?.percentage || 0) > 0 &&
                (progress?.percentage || 0) < 100 && (
                  <View className="absolute -top-1 -right-1 bg-black/40 rounded-full w-7 h-7 justify-center items-center">
  ...
  return (
    <>
      ...
      >
        {/* Achievement Title */}
        <Text
          className={`text-2xl font-bold text-center pt-7 ${
        ...
        {(progress?.percentage || 0) === 100 && achievement.completedDate && (
          <View className="items-center">
            ...
            >
              ...
              {achievement.completedDate.toLocaleString("en-US", {
                month: "short",
                day: "numeric",
                year: "numeric",
                hour: "2-digit",
          ...
          (progress?.percentage || 0) < 100 && (
            <View>
              ...
              {isFirstThreeAchievement(
                ...
                <View className="items-center">
                  <CountdownTimer
                    targetDate={calculateAchievementTargetDate(
                      startDate || null,
                      progress.max
                    )}

...
const Home = () => {
  ...
  const [purchaseItemType, setPurchaseItemType] = useState<
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium">
                  Go one full day without a single puff
                </span>
                <Badge variant="secondary">+25 coins</Badge>
              </div>
              <Progress value={75} className="h-2" />
              <p className="text-s text-muted-foreground mt-1">18 hours left</p>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  ...
                  >
                    ...
                    <div className="text-s text-muted-foreground">Day {i}</div>
                  </Card>
                ))}
              </div>
            </TabsContent>
                  ...
                  return (
                    <Card
                      ...
                      className={`p-4 text-center cursor-pointer transition-colors ${
                        isSelected
                          ? "bg-buddy-accent border-buddy-primary ring-2 ring-primary"
                          : isOwned
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-full h-8 rounded-md mb-2 mx-auto ${background.gradient}`}
                      ></div>
                      <div className="text-sm font-medium text-foreground mb-1">
                        {background.name}
                      </div>

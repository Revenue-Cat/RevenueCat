  ...
  const characters: ShopItem[] = [
    {
      ...
      name: "Chill Capybara",
      price: 0,
      owned: ownedCharacters.includes("1"),
    },
    {
      id: "2",
      emoji: "🐨",
      name: "Zen Koala",
      price: 150,
      owned: ownedCharacters.includes("2"),
    },
    {
      id: "3",
      emoji: "🦥",
      name: "Slow Sloth",
      price: 200,
      owned: ownedCharacters.includes("3"),
    },
    {
      id: "4",
      emoji: "🐧",
      name: "Cool Penguin",
      price: 100,
      owned: ownedCharacters.includes("4"),
    },
    {
      id: "5",
      emoji: "🐼",
      name: "Panda Bear",
      price: 200,
      owned: ownedCharacters.includes("5"),
    },
    {
      id: "6",
      emoji: "🦉",
      name: "Wise Owl",
      price: 100,
      owned: ownedCharacters.includes("6"),
      isNew: true,
    },
    {
      id: "7",
      ...
      name: "Duck Friend",
      price: 150,
      owned: ownedCharacters.includes("7"),
      isNew: true,
    },
  ];
  ...
  const accessories: ShopItem[] = [
    {
      ...
      name: "Top Hat",
      price: 50,
      owned: ownedAccessories.includes("1"),
    },
    {
      id: "2",
      emoji: "👓",
      name: "Glasses",
      price: 75,
      owned: ownedAccessories.includes("2"),
    },
    {
      id: "3",
      emoji: "🎪",
      name: "Party Hat",
      price: 100,
      owned: ownedAccessories.includes("3"),
    },
    {
      id: "4",
      emoji: "⚡",
      name: "Lightning",
      price: 300,
      owned: ownedAccessories.includes("4"),
    },
  ];
        ...
        return (
          ...
          >
            ...
            {selectedShopTab === "backgrounds" && item.gradient ? (
              <div
                className={`w-full h-8 rounded-md mb-2 mx-auto ${item.gradient}`}
              ></div>
            ) : (
      ...
      <Drawer open={showShop} onOpenChange={setShowShop}>
        <DrawerContent className="max-h-[90vh]">
          ...
          <div className="p-6 overflow-y-auto">
            ...
            {/* Shop Tabs */}
            <Tabs
              value={selectedShopTab}
              onValueChange={(value) => setSelectedShopTab(value as any)}
            >
